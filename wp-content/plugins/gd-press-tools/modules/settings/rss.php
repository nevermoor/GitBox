...
<tr><th scope="row"><?php _e("Expand RSS Items", "gd-press-tools"); ?></th>
    <td>
        ...
        <textarea style="width: 430px; height: 80px;" name="rss_header_contents"><?php echo esc_html($options["rss_header_contents"]); ?></textarea>
        <div class="gdsr-table-split"></div>
        ...
        <textarea style="width: 430px; height: 80px;" name="rss_footer_contents"><?php echo esc_html($options["rss_footer_contents"]); ?></textarea>
    </td>
</tr>
</tbody></table>
