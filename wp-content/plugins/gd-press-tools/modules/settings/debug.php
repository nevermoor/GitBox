...
<tr><th scope="row"><?php _e("SQL Queries", "gd-press-tools"); ?></th>
    <td>
        ...
        <div class="gdsr-table-split"></div>
        <input type="checkbox" name="debug_queries_admin" id="debug_queries_admin"<?php if ($options["debug_queries_admin"] == 1) echo " checked"; ?> /><label style="margin-left: 5px;" for="debug_queries_admin"><?php _e("Add SQL queries at the end of the admin pages.", "gd-press-tools"); ?></label>
        <br/>
        <input type="checkbox" name="debug_queries_blog" id="debug_queries_blog"<?php if ($options["debug_queries_blog"] == 1) echo " checked"; ?> /><label style="margin-left: 5px;" for="debug_queries_blog"><?php _e("Add SQL queries at the end of the blog pages.", "gd-press-tools"); ?></label>
        <div class="gdsr-table-split"></div>
